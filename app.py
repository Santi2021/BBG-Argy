...
SOURCE_COLORS = {
    ...
    "INVESTING": "#ffcc00", "WSJ": "#4ade80",
    "ÁMBITO": "#00ff41", "BL LÍNEA": "#a855f7", "INFOBAE": "#ff3b3b",
    "CRONISTA": "#60a5fa", "iPROF": "#c084fc",
}
...
st.markdown('<div class="ft">DATA VIA YAHOO FINANCE / DATA912 / BONDTERMINAL / DOLARAPI / ECOVALORES / TRADINGVIEW — SOLO FINES INFORMATIVOS</div>', unsafe_allow_html=True)
